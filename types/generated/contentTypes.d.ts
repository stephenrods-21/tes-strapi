...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    detailDescription: Attribute.Blocks;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiTeamTeam extends Schema.CollectionType {
  ...
  attributes: {
    ...
    isAmbassador: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiTestimageTestimage extends Schema.CollectionType {
  ...
  info: {
    singularName: 'testimage';
    pluralName: 'testimages';
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::testimage.testimage': ApiTestimageTestimage;
    }
  }
}
